...
export enum DetectedEntityStatus {
  ACTIVE = 'ACTIVE',
  INACTIVE = 'INACTIVE',
}

export enum DetectedEntitySource {
  ANALYZER = 'ANALYZER',
  POSTPROCESSOR = 'POSTPROCESSOR',
}

export enum DetectedEntitySystemReason {
  ANALYZER_DETECTED = 'ANALYZER_DETECTED',
  POSTPROCESSOR_ADDED = 'POSTPROCESSOR_ADDED',
  FILTERED_CONTEXT = 'FILTERED_CONTEXT',
  FILTERED_ALLOWLIST = 'FILTERED_ALLOWLIST',
  FILTERED_OVERLAP = 'FILTERED_OVERLAP',
  FILTERED_RULE = 'FILTERED_RULE',
}

export enum DetectedEntityUserReason {
  USER_BULK_ACTIVATE = 'USER_BULK_ACTIVATE',
  USER_BULK_DEACTIVATE = 'USER_BULK_DEACTIVATE',
  USER_SINGLE_UPDATE = 'USER_SINGLE_UPDATE',
  USER_RESET_OVERRIDE = 'USER_RESET_OVERRIDE',
}
